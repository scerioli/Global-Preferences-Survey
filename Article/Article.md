...
abstract: |
  This study replicates and extends the article of Falk and Hermle published in *Science* (2018), where the gender differences in economic preferences were related to economic development and to gender equality of the countries. In the original paper, the authors use the data from the Gallup World Poll 2012, which included a Global Preference Survey conducted on almost 80000 people in 76 countries all around the world. The dataset covers almost 90% of the world population representation, with each country having around 1000 participants and answering questions related to their time preference (patience), altruism, will of risk taking, negative and positive reciprocity, and trust. We suggestfully managed to replicate the describution of gender differences in economic preferences. Yet, during the replication, several methodological flaws in of the original study regarding the relation of gender differences to the economical deveolopment and gender equality were identified and further investigatied by us. In particularly, first, we revealed a strong and statisticallly significant correlation of gender equality indexes with economical development, expressed in Log GDP p/c. We argue that this correlaiton deminishes the role of the strong correlation between economic preferences and gender equality, if the not controled on economic development, and highlight the role of conditional analysis as the only was to separate this differences. Second, the joint gender equality index proposed by authors was found to have an architecure that leads to the disbalance of the factors that quantifiy the level of gender equality without justification and involve unvalidated and previously not reported indicators. Thus, manifesting no proof the the joint gender equality index performed no worse then any of other existing indicators. Third, we further conducted the conditional analysis with WEF, UNDP and GDI gender equality indexes. The analysis confirmed the presence of strong and statistically significant association of gender differences with economic development conditioned on gender equality. Yet, however the evidence for the association of gender differences with gender equality was found to be poor. More detailed investigation on signle preferences, further confirmed such conclusion, demonstrating mild and statistically significant association for only two preferences out of 18 preference-gender equality index combination. Our results suggest the absence of proof of stong and statistically significant association between economic preferences and gender equality given the data availible in the abovementined datasets, current methodological advances and indexes to measure gender equality. We also highlight and reaveal the importance of the validation and investigation of indexes used as a proxy for gender equality estimation as for the scientific discurs on the fundumental theories of social organization as well as for policy-makers and advisors.
