...
- [New_Analysis](https://github.com/scerioli/Global-Preferences-Survey/tree/master/New_Analysis) (will) contain the alternative analysis that we performed on the data.
