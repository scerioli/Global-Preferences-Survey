...
# Load the data
summaryIndex_robust <- fread("ExtendedAnalysis/files/output/extended_data_aggregatedByCountry_preferencePCA_genderIndexPCA.csv")
dataCoeff_summary_robust <- fread("ExtendedAnalysis/files/output/extended_data_aggregatedByCountry_singlePreference_genderCoefficients.csv")
